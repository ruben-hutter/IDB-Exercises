...
\item HeadOfDepartment(\underline{\uwave{ENo}}, Bonus) (Vertical partitioning) or\\ HeadOfDepartement(\underline{ENo}, EName, ESalary, Bonus, \uwave{DName}) (Horizontal partitioning)
